...
namespace COS_DesktopApp {
    ...
    public partial class CanteenOrderingSystemDataSet : global::System.Data.DataSet {
        ...
        public partial class accountDataTable : global::System.Data.TypedTableBase<accountRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public accountRow AddaccountRow(string email, string password, string fullname, System.DateTime birthday, string phonenumber, int id_role, System.DateTime deletedAt) {
        ...
        public partial class accountRow : global::System.Data.DataRow {
            ...
            public System.DateTime birthday {
                get {
                    return ((global::System.DateTime)(this[this.tableaccount.birthdayColumn]));
                }
                set {
            ...
            public System.DateTime deletedAt {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableaccount.deletedAtColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'deletedAt\' in table \'account\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableaccount.deletedAtColumn] = value;
                }
            }
            ...
            public bool IsdeletedAtNull() {
                return this.IsNull(this.tableaccount.deletedAtColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetdeletedAtNull() {
                this[this.tableaccount.deletedAtColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace COS_DesktopApp.CanteenOrderingSystemDataSetTableAdapters {
    ...
    public partial class accountTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[account] WHERE (([id] = @Original_id) AND ([email] = @Original_email) AND ([password] = @Original_password) AND ([fullname] = @Original_fullname) AND ([birthday] = @Original_birthday) AND ([phonenumber] = @Original_phonenumber) AND ([id_role] = @Original_id_role) AND ((@IsNull_deletedAt = 1 AND [deletedAt] IS NULL) OR ([deletedAt] = @Original_deletedAt)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[account] ([email], [password], [fullname], [birthday], [phonenumber], [id_role], [deletedAt]) VALUES (@email, @password, @fullname, @birthday, @phonenumber, @id_role, @deletedAt);
SELECT id, email, password, fullname, birthday, phonenumber, id_role, deletedAt FROM account WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[account] SET [email] = @email, [password] = @password, [fullname] = @fullname, [birthday] = @birthday, [phonenumber] = @phonenumber, [id_role] = @id_role, [deletedAt] = @deletedAt WHERE (([id] = @Original_id) AND ([email] = @Original_email) AND ([password] = @Original_password) AND ([fullname] = @Original_fullname) AND ([birthday] = @Original_birthday) AND ([phonenumber] = @Original_phonenumber) AND ([id_role] = @Original_id_role) AND ((@IsNull_deletedAt = 1 AND [deletedAt] IS NULL) OR ([deletedAt] = @Original_deletedAt)));
SELECT id, email, password, fullname, birthday, phonenumber, id_role, deletedAt FROM account WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, email, password, fullname, birthday, phonenumber, id_role, deletedAt F" +
                "ROM dbo.account";
        ...
        public virtual int Fill(CanteenOrderingSystemDataSet.accountDataTable dataTable) {
        ...
        public virtual CanteenOrderingSystemDataSet.accountDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CanteenOrderingSystemDataSet.accountDataTable dataTable = new CanteenOrderingSystemDataSet.accountDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CanteenOrderingSystemDataSet.accountDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_email, string Original_password, string Original_fullname, System.DateTime Original_birthday, string Original_phonenumber, int Original_id_role, global::System.Nullable<global::System.DateTime> Original_deletedAt) {
            ...
            if ((Original_deletedAt.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((System.DateTime)(Original_deletedAt.Value));
            }
            else {
        ...
        public virtual int Insert(string email, string password, string fullname, System.DateTime birthday, string phonenumber, int id_role, global::System.Nullable<global::System.DateTime> deletedAt) {
            if ((email == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_deletedAt.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((System.DateTime)(Original_deletedAt.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string email, string password, string fullname, System.DateTime birthday, string phonenumber, int id_role, global::System.Nullable<global::System.DateTime> deletedAt, int Original_id, string Original_email, string Original_password, string Original_fullname, System.DateTime Original_birthday, string Original_phonenumber, int Original_id_role, global::System.Nullable<global::System.DateTime> Original_deletedAt) {
            return this.Update(email, password, fullname, birthday, phonenumber, id_role, deletedAt, Original_id, Original_email, Original_password, Original_fullname, Original_birthday, Original_phonenumber, Original_id_role, Original_deletedAt, Original_id);
        }
    }
